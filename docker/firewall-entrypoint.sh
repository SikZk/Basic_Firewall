...
iptables -t nat -A POSTROUTING -s 172.20.0.0/24 -o "${LAN_IF}" -j MASQUERADE
iptables -t nat -A POSTROUTING -s 172.21.0.0/24 -o "${LAN_IF}" -j MASQUERADE
